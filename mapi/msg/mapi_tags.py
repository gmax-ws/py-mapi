__all__ = ['PidTagAttachDataBinary', 'PidTagAttachDataObject', 'PidTagDisplayName', 'PidTagDisplayTo',
           'PidTagTransportMessageHeaders', 'PidTagSubject', 'PidTagBody', 'PidTagRtfCompressed',
           'PidTagBodyHtml', 'PidTagBodyContentLocation', 'PidTagBodyContentId', 'PidTagAttachLongFilename',
           'PidTagAttachMimeTag', 'PidTagAttachSize', 'PidTagAttachNumber', 'PidTagSmtpAddress', 'PidTagEmailAddress',
           'PidTagOriginalSenderName', 'PidTagSentRepresentingName', 'PidTagSentRepresentingSmtpAddress',
