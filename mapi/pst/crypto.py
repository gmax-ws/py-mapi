...
def cyclic(data, dw_key):
    w = word(dw_key ^ (dw_key >> 16))
...
if __name__ == "__main__":
    v1 = permute(b"marius.gligor", True)
    v2 = permute(v1, False)
    print(v1, v2)

    v3 = cyclic(b"marius.gligor", 0x00000055)
    v4 = cyclic(v3, 0x00000055)
    print(v3, v4)
